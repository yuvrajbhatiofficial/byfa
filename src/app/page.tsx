...
const lookbookImages =[
  {id: 1, image: "vibe_001.jpg"},
  {id: 2, image: "vibe_002.jpg"},
  {id: 3, image: "vibe_003.jpg"},
  {id: 4, image: "vibe_004.jpg"},
  {id: 5, image: "vibe_005.jpg"},
  {id: 6, image: "vibe_006.jpg"}
...
export default function ByfaHomePage() {
  ...
  return (
    <div className="bg-black text-neutral-200 font-sans">
      ...
      >
        <div className="text-white font-bold text-lg">SNKRS</div>
      ...
      <main>
        ...
        <section id="about" ref={aboutRef} className="container mx-auto px-6 py-24 md:py-40 text-center">
          ...
          >
            Searching for the best Kick store in Austin? <br />
    ...
    />
      ...
      <footer className="bg-neutral-900 border-t border-neutral-800 mt-20">
        <div className="container mx-auto px-6 py-12 text-center">
          <div className="text-white font-bold text-lg mb-6">SNKRS</div>
          <p className="text-neutral-400 mb-6">
            The trendiest store in town. <br /> Located in Austin.
          </p>
          ...
          <p className="text-sm text-neutral-500">&copy; {new Date().getFullYear()} SNKRS Footwears. All Rights Reserved.</p>
        </div>
      </footer>
    </div>
  );
